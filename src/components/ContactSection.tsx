...
const FORMSPREE_ENDPOINT = "https://formspree.io/f/mojndkre";
  ...
  return (
    <section id="contact" className="py-24 sm:py-32 bg-secondary/30">
      <div className="section-container" ref={ref}>
        ...
        >
          <span className="text-xs tracking-[0.3em] uppercase text-primary font-medium">Contact</span>
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            {[
              { icon: Mail, label: "abeebayinla@gmail.com" },
              { icon: MapPin, label: "Open to Remote & Relocation" },
              { icon: Phone, label: "Available for Freelance" },
              {
                icon: MessageCircle,
                label: "Chat on WhatsApp",
                href: "https://wa.me/message/KZLFOXF72PUTE1",
              },
            ...
            <AnimatePresence mode="wait">
              {status === "success" ? (
                <motion.div
                  ...
                  style={{
                    boxShadow: "0 0 40px -10px hsl(174 62% 40% / 0.2), inset 0 1px 0 0 hsl(0 0% 100% / 0.05)",
                  }}
                >
                  <motion.div
                    initial={{ scale: 0 }}
                    ...
                    style={{ background: "var(--gradient-primary)", boxShadow: "0 8px 32px -8px hsl(174 62% 40% / 0.5)" }}
                  >
